...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos Inscritos " + devLeticia.getNome() + ": " + devLeticia.getConteudosInscritos());
        devLeticia.progredir();
        devLeticia.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos" + devLeticia.getNome() + ": " + devLeticia.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos"  + devLeticia.getNome() + ": " + devLeticia.getConteudosConcluidos());
